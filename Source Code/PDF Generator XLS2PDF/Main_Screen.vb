            ...
            If My.Computer.FileSystem.FileExists(TextBox1.Text) = True Then
                ...
                If My.Computer.FileSystem.FileExists(TextBox2.Text) = False Then
                    ...
                    Try
                        ...
                        Dim paramSourceBookPath As String = TextBox1.Text

                        Dim paramExportFilePath As String = TextBox2.Text
                    ...
                    Catch ex As Exception
                        Try
                            ...
                            Dim wdo As Microsoft.Office.Interop.Excel.Application = New Microsoft.Office.Interop.Excel.Application
                            Dim wdoc As Microsoft.Office.Interop.Excel.Workbook
                            Dim wdocs As Microsoft.Office.Interop.Excel.Workbooks
